...
import { DefaultOptions } from '../../config/datepicker.options';

@Component({
    selector: 'ngx-internal-datepicker',
...
export class DatepickerComponent implements OnInit {
     ...
     * Initial Options
     * ============================================== */
    public _options: DatePickerOptions = DefaultOptions;
    @Input('options')
    ...
    createCalendarArray(year: number, month: number): [{ weeks: Week[] }] {
        ...
        const _weeks = DatepickerService.createWeekArray(dayArray);
        return [{ weeks : _weeks }];
    }
